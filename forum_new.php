...
<link rel="stylesheet" type="text/css" media="screen" href="css/forum_new.css?123" />
</head>
    ...
    <div class="TabbedPanelsContent">
        ...
        <div class="forum-wrapper">
	    	<div class="forum-content-wrapper">
                ...
                <?php
				mysql_select_db($database_conn, $conn);
$query_discussions = sprintf("SELECT * FROM discussion WHERE discussion.category_id=%s",GetSQLValueString($row_categories['category_id'], "int"));
