...
<body>
<?php if (isset($_GET["co_name"])&&isset($_GET['id'])){ ?>
<form  name ="form3" method="post" action="update_res.php" enctype="multipart/form-data">
 <input type="text" readonly="readonly" name="r_name" id="r_name" value="<?php echo $_GET['co_name'];?>"/>
...
<?php } else echo 'Error: Incorrect parameters'; ?>
</body>
</html>