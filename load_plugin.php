...
if(isset($_GET['div'])) {
	//this part returns the internal video plugin data for redirection. it is called from function inside resource_float.js
	$query_get_resource= sprintf("SELECT * FROM `resource` WHERE r_id=%s",GetSQLValueString($_GET['div'], "int"));
	...
	echo '<a  
			 href="'.$row_get_resource['file_location'].'" 
			 style="display:block;width:620px;height:320px"  
			 id="player"> 
